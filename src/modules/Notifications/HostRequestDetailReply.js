...
export const HostRequestDetailReply = () => {
      ...
      >
        ...
        >
          <img
            ...
            alt=""
          />
          <H4 margin="0px 20px">{requestdetails?.to_user.username}</H4>
          <H5 margin="0px 20px" color="black">
            From : {requestdetails?.to_user.born_location}
          </H5>
          <H5 margin="0px 20px" color="black">
            Languages Speak : {requestdetails?.to_user.prefered_language}
          </H5>
          <H5 margin="0px 20px" color="black">
            Countries Visited : {requestdetails?.to_user.countries_visited}
          </H5>
          <H5 margin="0px 20px" color="black">
            Occupation : {requestdetails?.to_user.occupation}
          </H5>
        </Flex>
...
backgroundImage = "linear-gradient(315deg, #b8c6db 0%, #f5f7fa 74%)" 
        ...
        >
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            <H5>{dateFormat(requestdetails?.coming_date, "dddd, mmmm dS, yyyy")}</H5>
            ...
            />
            <H5>{dateFormat(requestdetails?.leaving_date, "dddd, mmmm dS, yyyy")}</H5>
            <Icon color="black" icon="fa-solid fa-clock" />
          ...
          <div style={{ display: "flex", flexDirection: "row" }}>
            ...
            >
              {requestdetails?.accept === true ? (
                <h4 style={{ color: "green" }}>Accepted Your Request</h4>
              ) : requestdetails?.decline === true ? (
                <h4 style={{ color: "red" }}>Declined Your Request</h4>
              ) : <h4>Requested</h4>}
            </div>
          ...
          {/* <Flex>
            <TextArea width=" 602px" marginLeft="54px"/>
            <Icon  marginLeft="20px" marginTop="50px"  backgroundColor="dodgerblue" icon="fa-solid fa-paper-plane"/>
          </Flex> */}
          ...
          >
            ...
            >
              <img
                ...
                alt=""
              />
              <H6 margin="0px 10px">{requestdetails?.from_user.username}</H6>
            </div>
