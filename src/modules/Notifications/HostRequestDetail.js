      ...
      >
        ...
        >
          <img
            ...
            alt=""
          />
          <H4 margin="0px 20px">{requestdetails?.from_user.username}</H4>
          <H5 margin="0px 20px" color="black">
            From : {requestdetails?.from_user.born_location}
          </H5>
          <H5 margin="0px 20px" color="black">
            Languages Speak : {requestdetails?.from_user.prefered_language}
          </H5>
          <H5 margin="0px 20px" color="black">
            Countries Visited : {requestdetails?.from_user.countries_visited}
          </H5>
          <H5 margin="0px 20px" color="black">
            Occupation : {requestdetails?.from_user.occupation}
          </H5>
        </Flex>
              ...
              {requestdetails?.accept === true ? (
                ...
                <>
                  <SecondaryBtn
                    ...
                    width="80px"
                    onClick={(req_id) =>
                      AcceptHostRequest((req_id = requestdetails?.id))
                    }
                  >
                    Yes
                  </SecondaryBtn>
                  <SecondaryBtn
                    ...
                    width="80px"
                    onClick={(req_id) =>
                      DeclineHostRequest((req_id = requestdetails?.id))
                    }
                  >
                    No
                  </SecondaryBtn>
